...
def main(arg):
	...
	if key_column not in source:
		print("The key_column is missed in source file!")
		return
	if key_column not in rule:
		print("The key_column is missed in rule file!")
		return	
...
def drop_useless_columns(key_column, source):
	...
	if key_column in source_rm_cols:
